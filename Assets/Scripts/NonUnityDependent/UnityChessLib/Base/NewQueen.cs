namespace UnityChess {
    public class NewQueen : NewPiece {
        public NewQueen(Square startingPosition, Side color) : base(startingPosition, color) {}
        public NewQueen(NewQueen queenCopy) : base(queenCopy) {}
