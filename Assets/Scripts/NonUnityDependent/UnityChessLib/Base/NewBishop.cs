namespace UnityChess {
    public class NewBishop : NewPiece {
        public NewBishop(Square startingPosition, Side color) : base(startingPosition, color) {}
        public NewBishop(NewBishop bishopCopy) : base(bishopCopy) {}
