...
namespace UnityChess {
    public class NewRook : NewPiece {
        public NewRook(Square startingPosition, Side color) : base(startingPosition, color) {}
        public NewRook(NewRook rookCopy) : base(rookCopy) {}
